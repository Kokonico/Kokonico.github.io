...
/** @type {string} */
const CACHE_VERSION = '1732568046|6748596010';
/** @type {string} */
const CACHE_PREFIX = 'sanitation-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'sanitation.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["sanitation.html","sanitation.js","sanitation.offline.html","sanitation.icon.png","sanitation.apple-touch-icon.png","sanitation.worker.js","sanitation.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["sanitation.wasm","sanitation.pck"];
